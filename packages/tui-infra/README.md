...
`node:smol-tui/<surface>` siblings - see the lockstep tracker at
[`docs/ports/smol-tui-lockstep.md`](../../docs/ports/smol-tui-lockstep.md),
which also names stuie's Rust `stuie-cabi` as the semantic reference this
...
<details><summary>Wiring into node-smol</summary>

...
describe('sEA Config VFS Configuration', () => {
  ...
  it(
    'should support boolean shorthand vfs: true with defaults',
    async () => {
      // Create JS file.
  ...
  it(
    'should support empty object vfs: {} with defaults',
    async () => {
      // Create JS file.
  ...
  it(
    'should support full VFS config with directory source',
    async () => {
      // Create JS file.
  ...
  it(
    'should support VFS config with .tar source',
    async () => {
      // Create JS file.
  ...
  it(
    'should support VFS config with .tar.gz source',
    async () => {
      // Create JS file.
  ...
  it(
    'should support compat mode without source',
    async () => {
      // Create JS file.
  ...
  it(
    'should prioritize CLI flags over sea-config.json',
    async () => {
      // Create JS file.

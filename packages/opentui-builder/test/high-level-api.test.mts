...
describe.skipIf(!nativeBuilt)('Buffer (high-level)', () => {
  let buf
...
describe.skipIf(!nativeBuilt)('TextBuffer (high-level)', () => {
  let tb
...
describe.skipIf(!nativeBuilt)('EditBuffer (high-level)', () => {
  let eb
...
describe.skipIf(!nativeBuilt)('EditorView (high-level)', () => {
  let eb
  let view
...
describe.skipIf(!nativeBuilt)('SyntaxStyle (high-level)', () => {
  let style
...
describe.skipIf(!nativeBuilt)('Renderer (high-level)', () => {
  let renderer
  ...
  it(
    ...
    { skip: !nativeBuilt || typeof native.writeOutBinary !== 'function' },
    () => {
      renderer = new Renderer(80, 24, { testing: true })
      expect(() => {
...
describe.skipIf(!nativeBuilt)('end-to-end: render pipeline', () => {

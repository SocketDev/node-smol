 ...
 *   credential reader in `../lib/notarize.mts`. `notarizeMachO` itself
 *   spawns `ditto`/`xcrun` and is exercised only manually against a real
 *   App Store Connect API key — no test here invokes either.
 */

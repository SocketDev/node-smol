...
- 🚨 The binary stubs exec with the live `environ`, never a captured `envp`; the regression test that pins this is still unwritten (node-smol#2). [`stub-environ-regression`](docs/agents.md/repo/stub-environ-regression.md)

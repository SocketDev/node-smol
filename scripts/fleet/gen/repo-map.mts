 ...
 *     `.repo-map`). Usage: node scripts/fleet/gen/repo-map.mts <file|dir>
 *     [<file|dir>…] node scripts/fleet/gen/repo-map.mts --write . node
 *     scripts/fleet/gen/repo-map.mts --write --changed
 */
...
export function writeCache(
  ...
  if (cfg.writeIndex) {
    ...
    const header = [
      '# Repo-map cache index — generated by scripts/fleet/gen/repo-map.mts.',
  ...
  if (changed) {
    ...
    if (walkRoots.length === 0) {
      process.stderr.write(
        'What: no path given.\n' +
          'Where: gen/repo-map.mts\n' +
          'Fix: node scripts/fleet/gen/repo-map.mts <file|dir> [<file|dir>…]\n' +
